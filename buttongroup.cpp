...
void ButtonGroup::initButtons()
{
    ...
    ui->playCards->setImage(":/images/chupai_btn-1.png", ":/images/chupai_btn-3.png", ":/images/chupai_btn-2.png");
    ...
    btns << ui->start << ui->playCard << ui->playCards << ui->pass
    ...
    connect(ui->playCards, &MyButton::clicked, this, &ButtonGroup::playHand);
